...
report["_fieldstrip"] = [
    {"part": "Magazine", "order": 1, "dir": [0, 0, -1], "dist_mm": 120, "name": "Магазин", "desc": "Коробчатый магазин на 17 патронов: подаватель с пружиной поднимает патроны к линии досылания."},
    {"part": "Slide", "order": 2, "dir": [1, 0, 0], "dist_mm": 200, "name": "Затвор в сборе", "desc": "Затвор несёт ударник, выбрасыватель и прицел; при выстреле откатывается и перезаряжает оружие."},
    {"part": "RecoilSpring", "order": 3, "dir": [1, 0, 0], "dist_mm": 120, "name": "Возвратная пружина в сборе", "desc": "Возвратная пружина с направляющим стержнем гасит откат затвора и возвращает его вперёд, досылая патрон."},
    {"part": "Barrel", "order": 4, "dir": [1, 0, 0.3], "dist_mm": 140, "name": "Ствол", "desc": "Ствол с патронником; при откате казённая часть опускается и отпирает затвор (схема Браунинга с перекосом)."},
    {"part": "Frame", "order": 5, "dir": [0, 0, 0], "dist_mm": 0, "name": "Рамка", "desc": "Рамка: полимерное основание с рукоятью, вмещает ударно-спусковой механизм и направляющие затвора."},
]
report["_fullstrip"] = [
    {"part": "SlideCoverPlate",  "group": "slide", "order": 1, "dir": [0, 0, -1],  "dist_mm": 40, "name": "Крышка затвора", "desc": "Крышка затвора удерживает сборку ударника в его канале."},
    {"part": "SpringCups",       "group": "slide", "order": 2, "dir": [0, 0, 1],   "dist_mm": 45, "name": "Полукольца пружины", "desc": "Полукольца фиксируют пружину ударника на стержне."},
    {"part": "FiringPinSpring",  "group": "slide", "order": 3, "dir": [-1, 0, 0],  "dist_mm": 70, "name": "Пружина ударника", "desc": "Пружина ударника разгоняет его при срыве с шептала."},
    {"part": "SpacerSleeve",     "group": "slide", "order": 4, "dir": [-1, 0, 0],  "dist_mm": 55, "name": "Муфта", "desc": "Муфта центрирует пружину ударника в канале затвора."},
    {"part": "Striker",          "group": "slide", "order": 5, "dir": [-1, 0, 0],  "dist_mm": 90, "name": "Ударник", "desc": "Ударник накалывает капсюль; взводится при откате затвора и удерживается шепталом тяги."},
    {"part": "FiringPinSafety",  "group": "slide", "order": 6, "dir": [0, 0, -1],  "dist_mm": 35, "name": "Предохранитель ударника", "desc": "Предохранитель ударника запирает его канал и опускается только при нажатии на спуск."},
    {"part": "ExtractorPlunger", "group": "slide", "order": 7, "dir": [0, 1, 0],   "dist_mm": 45, "name": "Толкатель выбрасывателя", "desc": "Толкатель с пружиной прижимает зацеп выбрасывателя к закраине гильзы."},
    {"part": "Extractor",        "group": "slide", "order": 8, "dir": [0, 1, 0],   "dist_mm": 40, "name": "Выбрасыватель", "desc": "Выбрасыватель захватывает закраину гильзы и извлекает её из патронника при откате."},
    {"part": "SlideLock",        "group": "frame", "order": 9, "dir": [0, -1, 0],  "dist_mm": 55, "name": "Защёлка разборки", "desc": "Защёлка разборки удерживает ствол и возвратную пружину в рамке; опускается при снятии затвора."},
    {"part": "LockingBlock",     "group": "frame", "order": 10, "dir": [0, 0, 1],  "dist_mm": 50, "name": "Блок запирания", "desc": "Блок запирания принимает проушину ствола и задаёт его перекос при откате."},
    {"part": "SlideStop",        "group": "frame", "order": 11, "dir": [0, -1, 0], "dist_mm": 45, "name": "Затворная задержка", "desc": "Затворная задержка останавливает затвор в заднем положении после последнего патрона."},
    {"part": "TriggerHousing",   "group": "frame", "order": 12, "dir": [0, 0, -1], "dist_mm": 60, "name": "Корпус УСМ с отражателем", "desc": "Корпус ударно-спускового механизма с отражателем: несёт шептало и отражает гильзу."},
