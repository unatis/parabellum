...
EXPOSURE_BIAS = 9.5   # ручная камера f/4 1/60 ISO100 = EV~10; солнце 10 lux даёт EV~4 -> компенсируем
...
def main():
    ...
    # Мишени - C++ актор APBLTargetDummy (меш/анимации берёт из DefaultGame.ini).
