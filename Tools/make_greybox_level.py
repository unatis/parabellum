...
SKY_INTENSITY = 5.0   # Ð½ÐµÐ±Ð¾ ÑÑ€Ñ‡Ðµ: Ñ‚ÐµÐ½Ð¸ Ð½Ðµ Ñ‡Ñ‘Ñ€Ð½Ñ‹Ðµ (Ñ€ÐµÐ°Ð»ÑŒÐ½Ð¾Ðµ Ð¾Ñ‚Ð½Ð¾ÑˆÐµÐ½Ð¸Ðµ ÑÐ¾Ð»Ð½Ñ†Ðµ/Ñ‚ÐµÐ½ÑŒ ~5-10:1; Ð´Ð»Ñ Ð¿Ð¾Ð»Ð¸Ð³Ð¾Ð½Ð° Ð½ÑƒÐ¶Ð½Ð° Ñ€Ð¾Ð²Ð½Ð°Ñ Ð¾ÑÐ²ÐµÑ‰Ñ‘Ð½Ð½Ð¾ÑÑ‚ÑŒ)
EXPOSURE_BIAS = 9.5   # Ñ€ÑƒÑ‡Ð½Ð°Ñ ÐºÐ°Ð¼ÐµÑ€Ð° f/4 1/60 ISO100 = EV~10; ÑÐ¾Ð»Ð½Ñ†Ðµ 10 lux Ð´Ð°Ñ‘Ñ‚ EV~4 -> ÐºÐ¾Ð¼Ð¿ÐµÐ½ÑÐ¸Ñ€ÑƒÐµÐ¼
...
def main():
    ...
    sky_c.set_intensity(SKY_INTENSITY)
