...
SCALARS = (("Aspect", 16.0 / 9.0), ("CenterFOV", 103.0), ("SideYaw", 60.0), ("SideFOV", 80.0), ("TotalFOV", 160.0), ("PaniniD", 2.2), ("CamPitch", 0.0), ("PitchAlignStart", 40.0), ("PitchAlignEnd", 70.0), ("SideExposureFix", 1.0), ("SideMip", 3.0),
           ("BlendStart", 35.0), ("BlendEnd", 50.0), ("BlurStartYaw", 50.0), ("BlurMaxDeg", 0.3), ("Debug", 0.0), ("Mode", 0.0), ("PanelCenterFrac", 0.7), ("PanelScale", 1.0), ("PanelSeparator", 0.003), ("CSHalfH", 53.13))
